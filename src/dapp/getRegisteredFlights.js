...
async function getRegisteredFlights()  {
    
    console.log("In getRegisteredFlights(). " );

    let getRegisteredFlights = await flightSuretyData.methods.getRegisteredAirlines().call({"from": accountsArr[0], 
                                                                    "gas": 4712388,
...
*****/
wrapperFn().then( () => {console.log("After  wrapperFn()z completed")})
